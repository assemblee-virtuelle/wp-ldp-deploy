...
CURRENTDIR=`pwd`
MAINFILE="wpldp.php" # this should be the name of your main php file in the wordpress plugin
SVNUSER="balessan" # your svn username (case sensitive)

# git config
GITPATH="$CURRENTDIR/" # this file should be in the base of your git repository

# svn config
SVNPATH="/home/balessan/workspace/wpldp-svn" # path to a temp SVN repo. No trailing slash required and don't add trunk.
